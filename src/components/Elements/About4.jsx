        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-12">
            <div className="scenario-box">
              <img src="/assets/Obama.webp" alt="Obama Deepfake" className="scenario-image" />
          ...
          <div className="col-lg-4 col-md-12">
            <div className="scenario-box">
              <img src="/assets/Fakedrake.webp" alt="Fake Drake" className="scenario-image" />
          ...
          <div className="col-lg-4 col-md-12">
            <div className="scenario-box">
              <img src="/assets/Vote.webp" alt="Deepfake Election" className="scenario-image" /><br></br>
